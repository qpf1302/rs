...
<body>
  <div class="container" style="position: relative;height: auto;min-height: 100%">
    ...
    <form style="text-align:center;" method="post" action="/index.php/Admin/Rule/addrules">
     <?php if(is_array($result)): foreach($result as $key=>$list): ?><table class="table table-striped table-bordered" style="text-align:center;width:70%;margin:auto auto;">
      <tr class="danger">
        <td width="30%" style="align:center"><strong>发放时间</strong></td>
        <td width="70%" style="align:center"><input type="date" name="date1" class="form-control" style="width:35%;" value="<?php echo ($list["date1"]); ?>"> 至 <input type="date" name="date2" class="form-control" style="width:35%;" value="<?php echo ($list["date2"]); ?>"></td>
      </tr>
      <tr style="height:40px;"></tr>
       <tr class="danger">
        <td width="30%" style="align:center"><strong>每天发放数量</strong></td>
        <td width="70%" style="align:center"><input type="text" name="num" class="form-control" style="width:35%;" value="<?php echo ($list["num"]); ?>"> 个</td>
      </tr>
      <tr style="height:40px;"></tr>
      <tr class="danger">
        <td width="30%" style="align:center"><strong>每天发放时间</strong></td>
        <td width="70%" style="align:center"><input type="time" name="time1" class="form-control" style="width:35%;" value="<?php echo ($list["time1"]); ?>"> 至 <input type="time" name="time2" class="form-control" style="width:35%;" value="<?php echo ($list["time2"]); ?>"></td>
      </tr>
      <tr style="height:40px;"></tr>
      <tr class="danger">
        <td width="30%" style="align:center"><strong>邀请码过期时间</strong></td>
        <td width="70%" style="align:center"><input type="date" name="outtime" class="form-control" style="width:35%;" value="<?php echo ($list["outtime"]); ?>">
      </tr>
       <tr style="height:40px;"></tr>
